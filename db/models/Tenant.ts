...
export default class Tenant extends Model {
    ...
    @text('stamp_url') stampUrl!: string
    @text('invoice_template') invoiceTemplate!: string
    @text('invoice_font') invoiceFont!: string
    @field('show_watermark') showWatermark!: boolean
